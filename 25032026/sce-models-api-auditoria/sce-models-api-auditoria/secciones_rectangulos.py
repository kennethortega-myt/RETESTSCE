...
def _load_aligned_image(img_name):
    file_path1, _, _ = download_file_from_dir_and_align(img_name, False, is_convencional=constantes.FLUJO_CONVENCIONAL, log_queue=constantes.QUEUE_LOGGER_VALUE_LISTA_ELECTORES)
...
def _detectar_tabla_principal(img, porcentaje_x):
    ...
    try:
        ...
        y1, y2 = int(0.020 * h_table), int(0.985 * h_table)
