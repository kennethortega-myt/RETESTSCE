...
export class ReporteElectoresOmisosApiService {
  ...
  private asignarUrlBackend() {
    ...
    obtenerReporteElectoresOmisos(filtros: FiltroElectoresOmisosBean): Observable<GenericResponseBean<string>> {
      ...
      const url = this.globalService.reemplazarDobleSlash(`${this.urlServidor}/${Constantes.CB_REPORTE_REPORTE_ELECTORES_OMISOS_POST_BASE64}`);
