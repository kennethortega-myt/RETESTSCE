...
export class ReporteMesasSinOmisosApiService {
  ...
  private asignarUrlBackend() {
    ...
    obtenerReporteMesasSinOmisos(filtros: FiltroElectoresOmisosBean): Observable<GenericResponseBean<string>> {
      ...
      const url = this.globalService.reemplazarDobleSlash(`${this.urlServidor}/${Constantes.CB_REPORTE_REPORTE_MESAS_SIN_OMISOS_POST_BASE64}`);
