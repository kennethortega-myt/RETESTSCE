...
export class AsistenciaPersonerosApiService {
    ...
    getReporteAsistenciaPersoneros(filtros: FiltroAsistenciaMiembroMesa):Observable<GenericResponseBean<string>>{
      ...
      const url = this.globalService.reemplazarDobleSlash(`${this.urlServidor}/${Constantes.CB_REPORTE_ASISTENCIA_PERSONEROS_POST_BASE64}`);
      return this.httpClient.post<GenericResponseBean<string>>(url, filtros, HTTPOptions);
    }
