...
export class MessageVerificacionActasService{
  ...
  private readonly fechaProcesoSubject = new BehaviorSubject<Date | null>(null);
  private readonly noData = new BehaviorSubject<boolean>(false);
  private readonly recargarObservacionesSubject = new Subject<void>();
  ...
  triggerRecargarObservaciones(): void {
    this.recargarObservacionesSubject.next();
  }

  getRecargarObservaciones(): Observable<void> {
    return this.recargarObservacionesSubject.asObservable();
  }
