...
export class ReporteMonitoreoActasComponent extends AuthComponent implements OnInit {
  ...
  constructor(
    ...
    private readonly reporteMonitoreoActaService: ReporteMonitoreoActaService,
