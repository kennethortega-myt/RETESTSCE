...
@Component({
  selector: 'app-pop-control-sc',
  templateUrl: './pop-control-sc.component.html',
})
export class PopControlSCComponent implements OnInit {
  tamanio: number = 100;
  anguloActa: number = 0;
  ...
  constructor(public dialog: MatDialog,
              ...
              public dialogRef: MatDialogRef<PopControlSCComponent>,
