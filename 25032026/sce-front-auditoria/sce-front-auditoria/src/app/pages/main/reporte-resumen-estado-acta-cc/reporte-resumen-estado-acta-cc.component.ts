...
@Component({
  selector: 'app-reporte-resumen-estado-acta-cc',
  templateUrl: './reporte-resumen-estado-acta-cc.component.html',
})
export class ReporteResumenEstadoActaCcComponent extends AuthComponent implements OnInit {
