...
@Component({
  selector: 'app-reporte-puestas-cero-cc',
  templateUrl: './reporte-puestas-cero-cc.component.html',
})
export class ReportePuestasCeroCcComponent extends AuthComponent implements OnInit {
