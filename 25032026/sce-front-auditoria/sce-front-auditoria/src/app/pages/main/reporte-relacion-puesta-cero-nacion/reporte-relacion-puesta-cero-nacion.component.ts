...
@Component({
  selector: 'app-reporte-relacion-puesta-cero-nacion',
  templateUrl: './reporte-relacion-puesta-cero-nacion.component.html',
})
export class ReporteRelacionPuestaCeroNacionComponent extends AuthComponent implements OnInit {
  ...
  private readonly tituloAlert = "Avance de estado de actas";
  private readonly destroyRef = inject(DestroyRef);

  constructor(
    private readonly generalService : GeneralService,
    private readonly reporteAvanceEstadoActasService: ReporteAvanceEstadoActasService,
