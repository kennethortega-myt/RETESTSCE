import {Component, DestroyRef, inject, Inject, OnInit, ElementRef, Renderer2 } from '@angular/core';
  ...
  async upload(data: any) {
    ...
    if (data.files) {
      ...
      try {
        ...
        console.error(error);
        await this.generalService.openDialogoGeneral({
          mensaje: "Error al procesar la imagen. Por favor, intente nuevamente.",
          icon: "warn",
          title: TitlePop.INFORMATION,
          success: false
        });
