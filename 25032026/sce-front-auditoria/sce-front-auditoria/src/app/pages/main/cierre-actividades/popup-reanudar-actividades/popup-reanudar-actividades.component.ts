import {Component, DestroyRef, HostListener, Inject, inject, OnInit, signal} from '@angular/core';
...
export class PopupReanudarActividadesComponent implements OnInit {
  ...
  getErrorMessage(controlName: string): string {
    const controlForm = this.reaperturaForm.get(controlName);
    ...
    if (controlForm?.hasError('maxlength')) {
      const maxLength = controlForm.errors?.['maxlength'].requiredLength;
    ...
    if (controlForm?.hasError('pattern')) {
