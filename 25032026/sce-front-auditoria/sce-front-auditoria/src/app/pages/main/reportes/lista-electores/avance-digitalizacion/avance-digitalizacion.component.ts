...
export class AvanceDigitalizacionComponent extends AuthComponent implements OnInit {
  ...
  private readonly tituloAlert = "Avance Digitalización de Lista Electores";
  private readonly destroyRef: DestroyRef = inject(DestroyRef);

  constructor(
    private readonly monitoreoService: MonitoreoNacionService,
    private readonly utilityService: UtilityService,
    private readonly avanceDigitalizacionListaElectoresService: AvanceDigitalizacionListaElectoresService,
