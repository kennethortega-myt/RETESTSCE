...
@Component({
  selector: 'app-mesas-sin-omisos-electores',
  templateUrl: './mesas-sin-omisos-electores.component.html',
})

export class MesasSinOmisosElectoresComponent extends AuthComponent implements OnInit {
  ...
  private readonly tituloAlert = "Mesas sin omisos de electores";
  ...
  constructor(
    ...
    private readonly reporteMesasSinOmisosService: ReporteMesasSinOmisosService,
  ) {
    super();
    ...
    this.reporteMesasSinOmisosService.obtenerReporteMesasSinOmisosNacion(filtros)
      ...
      .subscribe({
        ...
        error: () => {
          ...
          this.isShowReporte = false;
          this.utilityService.mensajePopup(this.tituloAlert, "No fue posible obtener el reporte de mesas sin omisos de electores.", IconPopType.ERROR);
        }
      })
  }
  ...
  mapearCampos(): FiltroElectoresOmisosBean {
    ...
    filtros.tipoReporteActorElectoral = 1; //Electores
    filtros.tipoReporte = 1;
    return filtros;
  }
