...
@Component({
  selector: 'app-avance',
  templateUrl: './miembros-mesa-acta-escrutinio.component.html',
})

export class MiembrosMesaActaEscrutinioComponent extends AuthComponent implements OnInit {
  ...
  private readonly tituloAlert = "Avance de registro de omisos";
  ...
  constructor(
    ...
    private readonly reporteElectoresOmisosService: ReporteElectoresOmisosService
  ) {
    super();
    ...
    this.reporteElectoresOmisosService.obtenerReporteElectoresOmisosNacion(filtros)
      ...
      .subscribe({
        ...
        error: () => {
          ...
          this.isShowReporte = false;
          this.utilityService.mensajePopup(this.tituloAlert, "No fue posible obtener el reporte de avance de omisos de miembros de mesa acta escrutinio.", IconPopType.ERROR);
        }
      })
  }
  ...
  mapearCampos(): FiltroElectoresOmisosBean {
    ...
    filtros.tipoReporteActorElectoral = 4;//Miembros de mesa acta escrutinio
