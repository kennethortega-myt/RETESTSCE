...
import { ResumenEstadoActasComponent } from './resumen-estado-actas/resumen-estado-actas.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'resumen-estado-actas', component: ResumenEstadoActasComponent, canActivate: [roleAuthorizationGuard] },
    ]
  }
];
