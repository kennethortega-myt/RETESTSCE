...
@Component({
  selector: 'app-dashboard-hojas-asistencia',
  templateUrl: './dashboard-hojas-asistencia.component.html',
  styleUrls: ['./dashboard-hojas-asistencia.component.scss']
})

export class DashboardHojasAsistenciaComponent implements AfterViewInit, OnDestroy {
