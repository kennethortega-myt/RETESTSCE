...
export class MesasSinOmisosMiembrosMesaComponent extends AuthComponent implements OnInit {
  ...
  private readonly tituloAlert = "Mesas sin omisos de miembros de mesa";
