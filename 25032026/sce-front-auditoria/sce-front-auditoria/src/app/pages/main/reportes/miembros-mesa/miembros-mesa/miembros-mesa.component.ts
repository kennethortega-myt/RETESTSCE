...
export class AvanceMiembrosMesaComponent extends AuthComponent implements OnInit {
  ...
  listaAvanceOmisos: AvanceOmisos[] = [
    ...
    { ubigeo: '010302', departamento: 'AMAZONAS', provincia: 'BONGARA', distrito:'COROSHA', totalMesas: 3, mesasRegistradas: 0, totalElectores: 3, totalOmisos: 2, porAvanceMesas: 0},
  ];
    ...
    this.reporteElectoresOmisosService.obtenerReporteElectoresOmisosNacion(filtros)
      ...
      .subscribe({
        ...
        error: () => {
          ...
          this.isShowReporte = false;
          this.utilityService.mensajePopup(this.tituloAlert, "No fue posible obtener el reporte de avance de omisos miembros de mesa.", IconPopType.ERROR);
        }
      })
  }
