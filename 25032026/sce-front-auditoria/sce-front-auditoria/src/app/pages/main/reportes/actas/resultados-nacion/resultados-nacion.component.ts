...
export class ResultadosNacionComponent extends AuthComponent implements OnInit {
  ...
  public readonly tituloAlert="Resultados";
  ...
  constructor(
    ...
    private readonly resultadosActasContabilizadasService: ResultadosActasContabilizadasService,
  ...
  get filtroResultadosActas(): FiltroResultados {
    ...
    return {
      ...
      distritoElectoral: this.listNivelUbigeoUno.find(de => de.id === this.form.get('nivelUbigeoUno').value)?.nombre,
      nombreUbigeoUno: this.labelNivelUbigeoUno,
      nombreUbigeoDos: this.labelNivelUbigeoDos,
      nombreUbigeoTres: this.labelNivelUbigeoTres
    }
  }
