...
public class StaeServiceImpl implements StaeService {
	...
	private final TransmisionStaeRepository transmisionStaeRepository;
	...
	public StaeServiceImpl(
			...
			TransmisionStaeRepository transmisionStaeRepository) {
		this.actaRepository = actaRepository;
		this.transmisionStaeRepository = transmisionStaeRepository;
	}
	...
	public ResultadoPs insertActaStae(String piEsquema, boolean esDesarrollo, String piActa, String usuario) {
		...
		logger.info("Inicio - Se ejecuto el procedimiento almacenado a las {}", new Date());
		Map<String, Object> resultadopc = transmisionStaeRepository.insertActaStae(
				piEsquema, 
				piActa, 
				usuario, 
				esDesarrollo);
		
		logger.info("Fin - Se ejecuto el procedimiento almacenado a las {}", new Date());
		if (resultadopc != null) {
