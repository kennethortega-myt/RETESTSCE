...
public interface IVersionExportMapper extends IMigracionMapper<VersionExportDto, Version>, IFechaMapper {

	@Mapping(target = "audUsuarioCreacion", source = "usuarioCreacion")
	@Mapping(target = "audUsuarioModificacion", source = "usuarioModificacion")
	@Mapping(target = "fechaVersion", source = "fechaVersion", qualifiedByName = "convertirFecha")
	...
	VersionExportDto toDto(Version version);
