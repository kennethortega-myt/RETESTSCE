...
/**
 * Strategy para reportes resumidos de eleccion Revocatoria Distrital
 */
public class TipoReporteCPRResumidoStrategyImpl implements TipoReporteStrategy {
    private final ResultadosActaRepository resultadosActaRepository;

    public TipoReporteCPRResumidoStrategyImpl(ResultadosActaRepository resultadosActaRepository) {
    ...
    public List<Map<String, Object>> obtenerDatos(FiltroResultadoContabilizadasDto filtro) {
        ...
        return resultadosActaRepository.resultadosActasContabilizadasResumidoCPR(
