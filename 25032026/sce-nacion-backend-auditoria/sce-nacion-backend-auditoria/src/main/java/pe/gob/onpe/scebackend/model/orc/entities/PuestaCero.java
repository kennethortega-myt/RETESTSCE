...
public class PuestaCero implements Serializable {

	private static final long serialVersionUID = -4994612104454742948L;
	
	@Id
	@Column(name = "n_puesta_cero_pk")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator_puesta_cero")
    @SequenceGenerator(name = "generator_version", sequenceName = "seq_tab_puesta_cero_pk", allocationSize = 1)
	private Long    id;
