...
public class EleccionPresidencialStrategyImpl extends EleccionStrategyAbstract {
    ...
    public static final String CODIGO_AGRUPACION_POLITICA = "c_codigo_agrupacion_politica";
    public static final String DESCRIPCION = "c_descripcion";
    ...
    private ReporteResultadoActasContDto mapearResultado(Map<String, Object> resultado) {
        return ReporteResultadoActasContDto.builder()
                .codAgrupacion(resultado.get(CODIGO_AGRUPACION_POLITICA) == null ? "" : resultado.get(CODIGO_AGRUPACION_POLITICA).toString())
                .desAgrupacion(resultado.get(DESCRIPCION) == null ? "" : resultado.get(DESCRIPCION).toString())
    ...
    private static List<DetalleResultadosContabilizadas> getDetalleResultado(List<Map<String, Object>> resultadosMap) {
        ...
        Double totalVotosEmitidos = resultadosMap
                .parallelStream()
                .map(v -> ((BigDecimal) v.get(VOTOS)).doubleValue() )
        ...
        return resultadosValidosMap
                ...
                .map(resultado -> {
                    ...
                    BigInteger votosBig = ((BigDecimal) resultado.get(VOTOS)).toBigInteger();
                    Double votosDouble = ((BigDecimal) resultado.get(VOTOS)).doubleValue();
                    ...
                    return DetalleResultadosContabilizadas
                            ...
                            .agrupacionPolitica(resultado.get(DESCRIPCION).toString())
