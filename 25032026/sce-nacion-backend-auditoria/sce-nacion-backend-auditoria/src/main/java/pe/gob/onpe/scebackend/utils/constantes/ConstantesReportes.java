...
public class ConstantesReportes {
    ...
    public static final String NAME_REPORTE_AVANCE_MESA_POR_MESA1 = "AvanceMesaPorMesa";
    public static final String NAME_REPORTE_AVANCE_MESA_POR_MESA_PREFERENCIAL = "AvanceMesaPorMesaPreferencial";
