...
import pe.gob.onpe.scebackend.model.service.reporte.IReporteDetalleAvanceRegistroUbigeoMiembroMesaService;
...
public class ReporteDetalleAvanceRegistroUbigeoMiembroMesaController extends BaseController {
    private final IReporteDetalleAvanceRegistroUbigeoMiembroMesaService reporteDetalleAvanceRegistroUbigeoMiembroMesaService;

    public ReporteDetalleAvanceRegistroUbigeoMiembroMesaController(TokenDecoder tokenDecoder, IReporteDetalleAvanceRegistroUbigeoMiembroMesaService reporteDetalleAvanceRegistroUbigeoMiembroMesaService) {
       super(tokenDecoder);
        this.reporteDetalleAvanceRegistroUbigeoMiembroMesaService = reporteDetalleAvanceRegistroUbigeoMiembroMesaService;
    }
