...
public abstract class EleccionStrategyAbstract implements EleccionStrategy {
    ...
    protected Map<String, Object> generarParametrosComunes(FiltroResultadoContabilizadasDto filtro, Map<String, Object> datos) {
        try {
            ...
            parametros.put("distritoElectoral", filtro.getDistritoElectoral());
            parametros.put("nombreUbigeoUno", filtro.getNombreUbigeoUno());
            parametros.put("nombreUbigeoDos", filtro.getNombreUbigeoDos());
            parametros.put("nombreUbigeoTres", filtro.getNombreUbigeoTres());
