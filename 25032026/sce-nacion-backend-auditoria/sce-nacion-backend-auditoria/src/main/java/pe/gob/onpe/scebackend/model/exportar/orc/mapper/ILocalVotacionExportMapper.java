...
public interface ILocalVotacionExportMapper extends IMigracionMapper<LocalVotacionExportDto, LocalVotacion>, IFechaMapper {

	@Mapping(target = "idUbigeo", source = "localVotacion.ubigeo.id")
	...
	LocalVotacionExportDto toDto(LocalVotacion localVotacion);
