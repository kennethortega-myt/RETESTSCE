...
import pe.gob.onpe.scebackend.model.orc.repository.reportes.ReporteOmisosElectoresRepository;
...
public class ReporteOmisosElectoresHandler implements ReporteOmisosHandler {
    ...
    private final String nombreColumna = ConstantesReportes.NOMBRE_COLUMNA_OMISOS_ELECTORES;
    ...
    private final String nombreReporteResumen = ConstantesReportes.NAME_REPORTE_OMISOS_ELECTORES_RESUMEN;
    private final String nombreReporteDetalle = ConstantesReportes.NAME_REPORTE_OMISOS_ELECTORES_DETALLE;
