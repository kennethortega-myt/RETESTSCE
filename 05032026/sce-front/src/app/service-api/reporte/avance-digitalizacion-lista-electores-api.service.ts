...
export class AvanceDigitalizacionListaElectoresApiService {
  ...
  getReporteAvanceDigitalizacionLENacion(filtro: FiltroReporteMesasObservaciones, acronimo: string):Observable<GenericResponseBean<string>>{
    ...
    const url = this.globalService.reemplazarDobleSlash(`${this.urlServidor}/${Constantes.CB_REPORTE_AVANCE_DIGITALIZACION_LE_BASE64}`);
