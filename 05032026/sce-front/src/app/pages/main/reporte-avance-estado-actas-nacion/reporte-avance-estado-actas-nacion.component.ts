...
export class ReporteAvanceEstadoActasNacionComponent extends AuthComponent implements OnInit, OnDestroy{
  ...
  constructor(
    ...
    //se comentó xq es una interface
    //this.avanceEstadoMesaReporteBean = new AvanceEstadoActaReporteBean();
