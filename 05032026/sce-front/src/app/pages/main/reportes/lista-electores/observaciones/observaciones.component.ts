...
export class ObservacionesComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  public tituloAlert="Mesas con Observaciones";
  ...
  constructor(
    ...
    private reporteMesasObservacionesService: ReporteMesasObservacionesService,
