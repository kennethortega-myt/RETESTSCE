...
export class OmisosAusentismoComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  public tituloAlert = "Reporte de Comparación Omisos Ausentismo";
  public mensaje: string = this.mensajeDefault;
  constructor(private formBuilder: FormBuilder,
              private monitoreoService: MonitoreoNacionService,
              private utilityService: UtilityService,
              private renderer: Renderer2,
              private reporteOmisosAusentismoService: ReporteOmisosAusentismoService,
  ) {
    super();
