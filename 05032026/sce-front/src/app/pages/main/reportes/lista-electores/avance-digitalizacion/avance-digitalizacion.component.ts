...
import {
  AvanceDigitalizacionListaElectoresService
} from '../../../../../service/reporte/avance-digitalizacion-lista-electores.service';

@Component({
  selector: 'app-avance-digitalizacion',
  templateUrl: './avance-digitalizacion.component.html'
})
export class AvanceDigitalizacionComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  public tituloAlert="Avance Digitalización de Lista Electores";
  ...
  constructor(
    ...
    private avanceDigitalizacionListaElectoresService: AvanceDigitalizacionListaElectoresService,
  ...
  buscarReporte(): void {
    ...
    this.avanceDigitalizacionListaElectoresService.getReporteAvanceDigitalizacionLENacion(filtro, this.form.get('proceso').value.acronimo)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (response) => {
