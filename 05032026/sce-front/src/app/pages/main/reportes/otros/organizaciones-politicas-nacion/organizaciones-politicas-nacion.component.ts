...
@Component({
  selector: 'app-organizaciones-politicas-nacion',
  templateUrl: './organizaciones-politicas-nacion.component.html',
})
export class OrganizacionesPoliticasNacionComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  public tituloAlert="Organizaciones Políticas";
  ...
  constructor(
    ...
    private reporteOrganizacionesPoliticasService: ReporteOrganizacionesPoliticasService,
  ) {
    super();
  ...
  buscarReporte(): void {
    ...
    this.reporteOrganizacionesPoliticasService.getReporteOrganizacionesPoliticasNacion(filtros, this.form.get('proceso').value.acronimo)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (response) => {
