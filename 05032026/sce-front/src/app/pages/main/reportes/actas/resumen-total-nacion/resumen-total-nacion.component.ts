...
export class ResumenTotalNacionComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  public tituloAlert="Resumen Total";
  ...
  constructor(
    ...
    private resumenTotalService: ResumenTotalService
  ) {
    super();
    this.listProceso = [];
    this.listEleccion = [];
  ...
  sonValidosLosDatosMinimos() :boolean{
    ...
    // if(!this.form.get('habilitado').value ||
    //   this.form.get('habilitado').value === '0'){
