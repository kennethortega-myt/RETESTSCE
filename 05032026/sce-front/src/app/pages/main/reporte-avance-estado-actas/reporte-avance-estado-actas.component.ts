...
@Component({
  selector: 'app-reporte-avance-estado-actas',
  templateUrl: './reporte-avance-estado-actas.component.html',
  styleUrls: ['./reporte-avance-estado-actas.component.scss']
})
export class ReporteAvanceEstadoActasComponent extends AuthComponent implements OnInit, OnDestroy{
  ...
  onProcesoChanged():void{
    const procesoControl = this.formGroupRepoAvanEstActFiltro.get('procesoFormControl');
    if (procesoControl){
  ...
  onEleccionChanged():void{
    const eleccionControl = this.formGroupRepoAvanEstActFiltro.get('eleccionFormControl');
    if (eleccionControl){
  ...
  onAmbitoChanged():void{
    const ambitoControl = this.formGroupRepoAvanEstActFiltro.get('ambitoFormControl');
    if (ambitoControl){
  ...
  onCentroComputoChanged(): void{
    const centroCompControl = this.formGroupRepoAvanEstActFiltro.get('centroComputoFormControl');
