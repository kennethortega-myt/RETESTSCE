...
@Component({
  selector: 'app-reporte-autoridades-consulta-cc',
  templateUrl: './reporte-autoridades-consulta-cc.component.html',
})
export class ReporteAutoridadesConsultaCcComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private reporteAutoridadesConsultaService: ReporteAutoridadesConsultaService,
  ...
  buscarReporte(){
    ...
    this.reporteAutoridadesConsultaService.getReporteAutoridadesEnConsultaPdfCc(filtros)
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (response) => {
