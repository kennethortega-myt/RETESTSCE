...
export class ReporteTotalCentroComputoComponent extends AuthComponent implements OnInit, OnDestroy{
  ...
  public tituloComponente = "Reporte total de centro de cómputo";


  constructor(
    private generalService : GeneralService,
    private reporteTotalCentroComputoService: ReporteTotalCentroComputoService,
