...
export class VerificaVersionNacionComponent extends AuthComponent implements OnInit, OnDestroy{
  ...
  constructor(
    ...
    private verificaVersionNacionService: VerificaVersionNacionService,
