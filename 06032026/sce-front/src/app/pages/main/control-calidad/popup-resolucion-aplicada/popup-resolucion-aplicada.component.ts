import { AfterViewInit, Component, DestroyRef, ElementRef, HostListener, inject, Inject, Renderer2, ViewChild } from '@angular/core';
...
@Component({
  ...
  styleUrl: './popup-resolucion-aplicada.component.scss'
})
