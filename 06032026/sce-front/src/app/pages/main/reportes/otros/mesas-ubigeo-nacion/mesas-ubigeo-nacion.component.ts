...
export class MesasUbigeoNacionComponent extends AuthComponent implements OnInit, OnDestroy{
  ...
  public tituloAlert="Mesas por Ubigeo";
  ...
  constructor(
    ...
    private reporteMesasUbigeoNacionService: ReporteMesasUbigeoNacionService,
