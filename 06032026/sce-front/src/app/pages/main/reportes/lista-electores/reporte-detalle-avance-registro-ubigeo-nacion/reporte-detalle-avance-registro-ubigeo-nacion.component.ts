...
import { ReporteDetalleAvanceRegistrosUbigeoNacionService } from 'src/app/service/reporte/reporte-detalle-avance-registros-ubigeo-nacion.service';
import { GenericResponseBean } from 'src/app/model/genericResponseBean';
import { generarPdf } from 'src/app/transversal/utils/funciones';

@Component({
  selector: 'app-reporte-detalle-avance-registro-ubigeo-nacion',
  templateUrl: './reporte-detalle-avance-registro-ubigeo-nacion.component.html'
})
export class ReporteDetalleAvanceRegistroUbigeoNacionComponent {
  protected mensajeDefault: string = 'Por favor, presione la opción CONSULTAR para realizar la búsqueda.';
  protected tituloAlert = "Reporte Detalle de Avance de Registros por Ubigeo";
  ...
  constructor(
    ...
    private readonly reporteDetalleAvanceRegistrosUbigeoNacionService: ReporteDetalleAvanceRegistrosUbigeoNacionService
  ) { }
  ...
  buscarReporte(filtro: FiltroReporteModeloUno): void {
    ...
    this.reporteDetalleAvanceRegistrosUbigeoNacionService.obtenerReporte(filtros)
  ...
  mapearCampos(filtro: FiltroReporteModeloUno): FiltroReporteDetalleAvanceRegistroUbigeo {
    ...
    filtros.ubigeoNivelDos = filtro.ubigeoNivelDos!=undefined?filtro.ubigeoNivelDos.codigo:"000000";
    filtros.ubigeoNivelTres = filtro.ubigeoNivelTres!=undefined?filtro.ubigeoNivelTres.codigo:"000000";
    return filtros;
  }
