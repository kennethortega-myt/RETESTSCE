...
export class AvanceDigitalizacionDenunciasComponent extends AuthComponent implements OnInit, OnDestroy {
  ...
  public tituloAlert="Avance Digitalización de Denuncias";
  ...
  constructor(
    ...
    private avanceDigitalizacionDenunciaService: AvanceDigitalizacionDenunciaService,
