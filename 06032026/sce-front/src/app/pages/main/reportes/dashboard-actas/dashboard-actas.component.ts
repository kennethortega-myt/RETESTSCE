...
@Component({
  selector: 'app-dashboard-actas',
  templateUrl: './dashboard-actas.component.html',
  styleUrls: ['./dashboard-actas.component.scss']
})
export class DashboardActasComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    // Agregar datos
    series2.data.setAll([
      { category: "Participación", value: 150 },
      { category: "Ausentismo", value: 25 },
    ]);
