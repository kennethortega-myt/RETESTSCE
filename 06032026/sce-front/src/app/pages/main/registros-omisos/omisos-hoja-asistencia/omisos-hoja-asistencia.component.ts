...
export class OmisosHojaAsistenciaComponent extends AuthComponent implements OnInit, OnDestroy{
  ...
  getReadonlyDni(index: number): boolean {
    const asistioUser = this.data.paginas[0].secciones[index].asistioUser;
    const asistioAutomatico = this.data.paginas[0].secciones[index].asistioAutomatico;
