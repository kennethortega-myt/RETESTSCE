...
export class ReporteDetalleAvanceRegistrosUbigeoMiembroDeMesaApiService {
  ...
  obtenerReporte(filtros: FiltroReporteDetalleAvanceRegistroUbigeo): Observable<GenericResponseBean<string>> {
    ...
    const url = this.globalService.reemplazarDobleSlash(`${this.urlServidor}/${Constantes.CB_REPORTE_DETALLE_AVANCE_REGISTROS_UBIGEO_MM_POST_BASE64}`);
