...
export class AvanceDigitalizacionApiService {
  ...
  getReporteAvanceDigitalizacionNacion(filtros: FiltroAvanceDigitalizacion, acronimo: string):Observable<GenericResponseBean<string>>{
    ...
    const url = this.globalService.reemplazarDobleSlash(`${this.urlServidor}/${Constantes.CB_REPORTE_AVANCE_DIGITALIZACION_ACTAS_POST_BASE64}`);
